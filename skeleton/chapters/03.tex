...
In \SYQ, as in other Quechuan languages, the class of substantives\index[sub]{substantive!classes} comprises six subclasses: nouns, pronouns, interrogative-indefinites, adjectives, pre-adjectives, and numerals. §~\ref{sec:nouns}--\ref{sec:numerals} cover each of these in turn. Multiple-class substantives and the dummy noun \phono{na} are covered in §~\ref{sec:mcsub} and~\ref{sec:dummyna}, respectively.
...
\SYQ{} has three pronominal stems --~\phono{ñuqa}, \phono{qam}, and \phono{pay}, as in~(\ref{Glo3:Kala}),~(\ref{Glo3:Manamnuqa}) and~(\ref{Glo3:Payqa}). These correspond to the first, second and third persons.
...
\glotran{I’m going to give youthis money. Get going \pb{whereever}!}{}%eng+spa trans
{}{}%rec - time
...
\noindent
General numerals are ambivalent, functioning both as modifiers and pronouns~(\ref{Glo3:Ishkayllata}).\\
...
The substantive (“possessive”) person suffixes of \SYQ{} are \phono{-y} (\AMV, \LT) or \phono{-:} (\ACH, \CH, \SP) (1\lsc{p}), \phono{-Yki} (2\lsc{p}), \phono{-n} (3\lsc{p}), and \phono{-nchik} (1\lsc{pl}) (\phono{mishi\pb{-y}}, \phono{mishi-\pb{:}} ‘my cat’; \phono{asnu-\pb{yki}} ‘your donkey’). Table~\ref{Tab10} displays this paradigm.

The plural suffix of \SYQ{} is \phono{-kuna} (\phono{urqu-\pb{kuna}} ‘hills’).

\SYQ{} has ten case suffixes: comparative \phono{-hina} (\phono{María-hina} ‘like María’); limitative \phono{-kama} (\phono{marsu-kama} ‘until March’); allative, dative \phono{-man} (\phono{Cañete-man} ‘to Cañete’); genitive and locative \phono{-pa} (\phono{María-pa} ‘María’s’ \phono{Lima-pa} ‘in Lima’); ablative, benefactive, and purposive \phono{-paq} (\phono{Viñac-paq} ‘from Viñac’, \phono{María-paq} ‘for María’ \phono{qawa-na-n-paq} ‘in order for her to see’); locative \phono{-pi} (\phono{Lima-pi} ‘in Lima’); exclusive \phono{-puRa} (\phono{amiga-pura} ‘among friends’); causative \phono{-rayku} (\phono{María-rayku} ‘on account of María’); accusative \phono{-ta} (\phono{María-ta} ‘María’ (direct object)), and comitative and instrumental \phono{-wan} (\phono{María-wan} ‘with María’, \phono{acha-wan} ‘with an axe’). Table~\ref{Tab11} displays this paradigm.
...
\phono{-kuna} pluralizes\index[sub]{substantive!number inflection} regular nouns, as in~(\ref{Glo3:Kabrakuna}), where it affixes to \phono{kabra} ‘goat’ to form \phono{kabra-\pb{kuna}} ‘goats’. \phono{-kuna} also pluralizes the personal pronouns \phono{ñuqa}, \phono{qam}, and \phono{pay}~(\ref{Glo3:Awanmi}), demonstrative pronouns~(\ref{Glo3:Chaykuna}), and interrogative-indefinites~(\ref{Glo3:Imakuna}).\\
...
\noindent
Finally, words borrowed from Spanish already inflected for plural --i.e.,~with Spanish plural \textit{s}~-- are generally still suffixed with \phono{-kuna} (‘cosas’~→~\phononb{kusas}\phononb{-ni}\phononb{-nchik}\phononb{-kuna})~(\ref{Glo3:Qayashpa}).\\
...
The simulative \phono{-hina}\index[sub]{simulative} indicates resemblance or comparison\index[sub]{comparative} (\phono{yawar-\pb{hina}} ‘like blood’)~(\ref{Glo3:Nawilla}--\ref{Glo3:kunachatam}).\\
...
The limitative \phono{-kama}\index[sub]{limitative} --~sometimes realized \phono{kaman}~-- indicates a limit in space~(\ref{Glo3:Qatimushaq}),~(\ref{Glo3:wambraykita}) or time~(\ref{Glo3:Fibriru}--\ref{Glo3:Kandawniypis}).\\
...
The allative and dative (directional) \phono{-man}\index[sub]{allative} indicates movement toward a point~(\ref{Glo3:Qinwalman}),~(\ref{Glo3:Hinashpachaypaq}) or the end-point of movement or action more generally~(\ref{Glo3:Wakwasikuna}),~(\ref{Glo3:Kabrataqaqa}).\\
...
\noindent
With \phono{-na} nominalizations, \phono{-ta} may be omitted. In many instances, \phono{-ta} does not indicate accusative case. \phono{-ta} may indicate the goal of movement of a person, as in~(\ref{Glo3:Siqashpaqa}) and~(\ref{Glo3:rirqani}), \phono{-n-ta} may indicate \lsc{path}~(\ref{Glo3:shamushpa}).\footnote{Thanks to Willem Adelaar for pointing this out to me.}\\
...
\noindent
Followed by an possessive suffix plus the copula auxiliary inflected for third person (null just in case tense/aspect are not specified), \phono{-na} indicates necessity (i.e.,~it forms a universal deontic/teleological modal) (\phono{taqsa-na-yki} ‘you have to wash’)~(\ref{Glo3:Sibadayta}),~(\ref{Glo3:Hinata}).\\
