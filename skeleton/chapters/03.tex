...
\noindent
Finally, words borrowed from Spanish already inflected for plural --i.e.,~with Spanish plural \it{s}~-- are generally still suffixed with \phono{-kuna} (‘cosas’~→~\phononb{kusas}\phononb{-ni}\phononb{-nchik}\phononb{-kuna})~(\ref{Glo3:Qayashpa}).\\
