...
The class of substantives in Quechuan languages is usually defined to include nouns (\phono{wasi} ‘house’); pronouns (\phono{ñuqanchik} ‘we’); interrogative-indefinites (\phono{may} ‘where’); adjectives (\phono{sumaq} ‘pretty’); pre-adjectives (\phono{dimas} ‘too’); and numerals (\phono{kimsa} ‘three’). All substantives with the exception of dependent pronouns (\phono{Sapa} ‘alone’) may occur as free forms.
...
The class of particles is usually defined to include interjections (\phono{¡Alaláw!} ‘How cold!’); prepositions (\phono{asta} ‘until’); coordinators (\phono{icha} ‘or’); prenumerals (\phono{la}, \phono{las}, occurring with expressions of time); negators (\phono{mana} ‘no, not’); assenters and greetings (\phono{aw} ‘yes’); adverbs (\phono{ayvis} ‘sometimes’).
...
In \SYQ, as in other Quechuan languages, the class of substantives\index[sub]{substantive!classes} counts six subclasses: nouns, pronouns, interrogative-indefinites, adjectives, pre-adjectives, and numerals. §~\ref{sec:nouns}--\ref{sec:numerals} cover each of these in turn. Multiple-class substantives and the dummy noun \phono{na} are covered in §~\ref{sec:mcsub} and~\ref{sec:dummyna}, respectively.

\subsection{Nouns}\label{sec:nouns}
The class of nouns\index[sub]{nouns} may be divided into four sub-classes: regular nouns (\phono{wayta} ‘flower’), time nouns (\phono{kanan} ‘now’), gender nouns (\phono{tiya} ‘aunt’), and locative nouns (\phono{qipa} ‘behind’). §~\ref{ssec:regnouns}--\ref{ssec:locnouns} cover each of these in turn.

\subsubsection{Regular nouns}\label{ssec:regnouns}
The class of regular nouns\index[sub]{nouns!regular} includes all nouns not included in the other three classes.~(\ref{Glo3:Warmi}--\ref{Glo3:Ukucha}) give examples.\\
...
\SYQ{} counts three pronominal stems --~\phono{ñuqa}, \phono{qam}, and \phono{pay}, as in~(\ref{Glo3:Kala}),~(\ref{Glo3:Manamnuqa}) and~(\ref{Glo3:Payqa}). These correspond to the first, second and third persons.
...
\noindent
These may but need not inflect for number as \phono{ñuqa-kuna}\index[sub]{ñuqakuna@ñuqakuna}, \phono{qam-kuna}, and \phononb{pay}\phononb{-kuna}~(\ref{Glo3:Unay}), (\ref{Glo3:Qamkuna}) and~(\ref{Glo3:Manachupaykuna}).\\
...
\noindent
\SYQ{} makes available a three-way distinction in the first person plural among \phono{ñuqa-nchik} (dual), \phono{ñuqa-nchik-kuna}\index[sub]{ñuqanchikkuna@ñuqanchikkuna} (inclusive), and \phono{ñuqa-kuna} (exclusive)~(\ref{Glo3:Ishkaykashpalla}), (\ref{Glo3:Kaypi}), (\ref{Glo3:Unay}).\\
...
\noindent
In practice, except in \CH, \phono{ñuqa-nchik} is employed with dual, inclusive and exclusive interpretations to the virtual complete exclusion of the other two forms. Verbs and substantives appearing with the inclusive \phono{ñuqa-nchik-kuna} inflect as do verbs and substantives appearing with the dual/default \phono{ñuqa-nchik}~(\ref{Glo3:Kriyi}); verbs and substantives appearing with the exclusive \phono{ñuqa-kuna} inflect as do verbs and substantives appearing with the singular \phono{ñuqa}~(\ref{Glo3:Familyallan}),~(\ref{Glo3:Puntra}).\\
...
\SYQ{} counts three demonstrative pronouns\index[sub]{pronouns!demonstrative}: \phono{kay} ‘this’, \phono{chay} ‘that’, and \phono{wak} ‘that (other)’~(\ref{Glo3:Kayqa}--\ref{Glo3:Wakmulaqa}).\\
...
\SYQ{} counts four dependent pronouns\index[sub]{pronouns!dependent}: \phono{kiki-} ‘oneself’~(\ref{Glo3:hukkunapaq}), \phono{Sapa-} ‘alone’~(\ref{Glo3:Yatrarqani}), \phono{llapa-} ‘all’~(\ref{Glo3:Llapanta}), and \phono{kuska-} ‘together’~(\ref{Glo3:Mikuypaqpis}).\\
...
\noindent
All except \phono{kiki} may occur as free forms as well; they occur freely not as pronouns, however, but as adjectives~(\ref{Glo3:pantyunman}) or adverbs~(\ref{Glo3:Imaynachay}).\\
...
\glotran{I’m going to give you this money. Get going \pb{wherever}!}{}%eng+spa trans
{}{}%rec - time
...
\glotran{Sometimes they denounced landholders for their fields, \pb{for anything at all}.}{}%eng+spa trans
{}{}%rec - time
...
\glotran{\pb{Why} did they do that to him? \pb{Whyever}?}{}%eng+spa trans
{}{}%rec - time
...
\SYQ{} employs two sets of cardinal numerals\index[sub]{numerals}. The first is native to Quechua; the second is borrowed from Spanish. The latter is always used for time and almost always for money. Also borrowed from Spanish are the ordinal numerals, \phono{primiru} ‘first’, \phono{sigundu} ‘second’, and so on. There is no set of ordinal numerals native to \SYQ. §~\ref{ssec:gennum}--\ref{ssec:timenum} cover general numerals, ordinal numerals, and time numerals in turn. §~\ref{ssec:numallaff} and~\ref{ssec:huk} cover numerals inflected for possessive and the special case of \phono{huk} ‘one’, respectively.
...
{‘Dos Huancaínos se alojaron en una cueva’.}%spa
{}{}%rec - time
...
\noindent
‘twenty’, ‘thirty’ and so on are formed by placing a unit numeral --~\phono{ishkay} ‘two’, \phono{kimsa} ‘three’, \emph{etc.}~-- in attributive construction with \phono{trunka} ‘ten’~(\ref{Glo3:Riganchik}).\\
...
\noindent
General numerals are ambivalent, functioning both as adjectives and pronouns~(\ref{Glo3:Ishkayllata}).\\
...
\noindent
Time expressions are generally suffixed with \phono{-ta} (\phono{a las dusi-ta} ‘at twelve o’clock’)~(\ref{Glo3:Lastris}).\\
...
\noindent
It may serve both as an indefinite determiner~(\ref{Glo3:Hukinhiniyrush}),~(\ref{Glo3:Hinaptinna}) and as a pronoun~(\ref{Glo3:Puchkapaqa}),~(\ref{Glo3:Ayvis}).\\
...
\phono{na} is a dummy noun\index[sub]{dummy noun}, standing in for any substantive that does not make it off the tip of the speaker’s tongue~(\ref{Glo3:Waknalawku}),~(\ref{Glo3:Wanqakunchik}).\\
...
\SYQ{} counts ten case suffixes: comparative \phono{-hina} (\phono{María-hina} ‘like María’); limitative \phono{-kama} (\phono{marsu-kama} ‘until March’); allative, dative \phono{-man} (\phono{Cañete-man} ‘to Cañete’); genitive and locative \phono{-pa} (\phono{María-pa} ‘María’s’ \phono{Lima-pa} ‘in Lima’); ablative, benefactive, and purposive \phono{-paq} (\phono{Viñac-paq} ‘from Viñac’, \phono{María-paq} ‘for María’ \phono{qawa-na-n-paq} ‘in order for her to see’); locative \phono{-pi} (\phono{Lima-pi} ‘in Lima’); exclusive \phono{-puRa} (\phono{amiga-pura} ‘among friends’); causative \phono{-rayku} (\phono{María-rayku} ‘on account of María’); accusative \phono{-ta} (\phono{María-ta} ‘María’ (direct object)), and comitative and instrumental \phono{-wan} (\phono{María-wan} ‘with María’, \phono{acha-wan} ‘with an axe’).

All case processes consist in adding a suffix to the last word in the nominal phrase. When a stem bears suffixes of two or three classes, these appear in the order person-number-case~(\ref{Glo3:Blusalla}),~(\ref{Glo3:Kusasni}).\\
...
\noindent
The third person possessive suffix, \phono{-n}, attaching to \phono{may} ‘where’ and other expressions of place, forms an idiomatic expression interpretable as ‘via’ or ‘around’ (\ref{Glo3:Hamuyaq}), (\ref{Glo3:Vikunachayta}).\\
...
\glotran{I left my little \textit{vicuña} with \pb{my father}.}{}%eng+spa trans
{}{}%rec - time

\noindent
In the first person singular, the noun \phono{papa} ‘father’ inflects \phono{papa-ni-y} to refer to one’s biological or social father~(\ref{Glo3:wambrayki}).\footnote{An anonymous reviewer writes, “As a loan word, most Central Quechuan languages have \emph{papa:} with final vowel length (reinterpretation of final accent in Spanish ‘\spanish{papá}’). As such, \phono{-ni} is required before a syllable-closing suffix, such as \phono{-y}. Though \phono{papa} does not end in a long vowel in SYQ, it probably did at one time, and the effect is retained.”}\\
...
\noindent
\SYQ{} possessive constructions are formed \lsc{substantive}-\lsc{poss} \phono{ka-} (\pb{allqu-n ka-rqa} ‘she had a dog’ (\lit~‘her dog was’))~(\ref{Glo3:Yasqayaruptiki}).\\
...
\noindent
Finally, possessive suffixes attach to the subordinating suffix \phono{-pti} as well as to the nominalizing suffixes \phono{-na} and \phono{-sa} to form subordinate~(\ref{Glo3:Hampikunaykipaq}), purposive~(\ref{Glo3:Atipasantatriki}), complement~(\ref{Glo3:Chaywawqin}) and relative~(\ref{Glo3:Truraykun}) clauses.\\
...
\phono{-kuna} pluralizes\index[sub]{substantive!number inflection} regular nouns~(\ref{Glo3:Kabrakuna}), the personal pronouns \phono{ñuqa}, \phono{qam} and \phono{pay}~(\ref{Glo3:Awanmi}), demonstrative pronouns~(\ref{Glo3:Chaykuna}), and interrogative-indefinites~(\ref{Glo3:Imakuna}) (\phono{kabra} ‘goat’ → \phono{kabra-\pb{kuna}} ‘goats’).\\
...
\noindent
Finally, words borrowed from Spanish already inflected for plural --~\ie,~with Spanish plural “s”~-- are generally still suffixed with \phono{-kuna} (‘cosas’~→~\phononb{kusas}\phononb{-ni}\phononb{-nchik}\phononb{-kuna})~(\ref{Glo3:Qayashpa}).\\
...
\Qyell{\phono{-rayku}} & reason & \Qyell{Chawa-shi-q lichi-lla-n-rayku ri-y-man-tri.} & ‘I might go help milk [the cows] \pb{on account} of her milk.’	\\
...
Simulative. \phono{-hina}\index[sub]{simulative} indicates resemblance or comparison\index[sub]{comparative} (\phono{yawar-\pb{hina}} ‘like blood’)~(\ref{Glo3:Nawilla}--\ref{Glo3:kunachatam}).\\
...
\glotran{Her teeth finished off. She can’t eat. \pb{Like} an old lady.}{}%eng+spa trans
{}{}%rec - time
...
Limitative. \phono{-kama}\index[sub]{limitative} --~sometimes realized \phono{kaman}~-- indicates a limit in space~(\ref{Glo3:Qatimushaq}),~(\ref{Glo3:wambraykita}) or time~(\ref{Glo3:Fibriru}--\ref{Glo3:Kandawniypis}).\\
...
\glotran{We walked \pb{while} blisters formed on the soles of our feet. I went \pb{while} blisters came up on my feet.}{}%eng+spa trans
{}{}%rec - time
...
\glotran{From San Jerónimo \pb{to} here.}{}%eng+spa trans
{}{}%rec - time
...
Allative, dative (directional). \phono{-man}\index[sub]{allative} indicates movement toward a point~(\ref{Glo3:Qinwalman}),~(\ref{Glo3:Hinashpachaypaq}) or the end-point of movement or action more generally~(\ref{Glo3:Wakwasikuna}),~(\ref{Glo3:Kabrataqaqa}).\\
...
\glotran{If you make her get \pb{to} the \textit{quingual} grove, she could die.}{}%eng+spa trans
{}{}%rec - time
...
Genitive, locative. As a genitive\index[sub]{genitive!\phono{-pa}}, \phono{-pa} indicates possession~(\ref{Glo3:Runapa}),~(\ref{Glo3:Imaynataqqam}); it is often paired with possessive inflection~(\ref{Glo3:Mananammiran}),~(\ref{Glo3:Puchkanchik}).\\
...
\glotran{I work \pb{wherever}, \pb{wherever}.}{}%eng+spa trans
{}{}%rec - time
...
\glotran{They say that \pb{in} Quechua: “I’ll herd it uphill.”}{}%eng+spa trans
{}{}%rec - time

\subsubsection{Ablative, benefactive, purposive \phono{-paq}}\label{ssec:ablbenpur}
Ablative, benefactive, purposive. As an ablative\index[sub]{ablative}, \phono{-paq} indicates provenance in space~(\ref{Glo3:Imaytaq}--\ref{Glo3:suwamuranki}) or time~(\ref{Glo3:Uchuklla}),~(\ref{Glo3:riqsinakushun}); origin or cause~(\ref{Glo3:walmitaqa}),~(\ref{Glo3:Wambray}); or the material of which an item is made~(\ref{Glo3:Llikllakuna}),~(\ref{Glo3:Ayvisruwani}).\\
...
\noindent
Suffixing to the distal demonstrative \phono{chay}, \phono{-paq} indicates a close temporal or causal connection between two events, translating ‘then’ or ‘so’~(\ref{Glo3:Balinaku}).\\
...
Locative. As a locative\index[sub]{locative!\phono{-pi}}, \phono{-pi} indicates temporal~(\ref{Glo3:Kananpuntraw}),~(\ref{Glo3:Uktubripaqway}) and spatial location~(\ref{Glo3:chakirusa}--\ref{Glo3:atuqta}).\\
...
Reason. \phono{-rayku}\index[sub]{causative} indicates motivation~(\ref{Glo3:Chawashiq}),~(\ref{Glo3:Papallayki}) or reason~(\ref{Glo3:Waynayki}),~(\ref{Glo3:Mikunallan}). It generally but not obligatorily follows possessive inflection~(\ref{Glo3:Chawashiq}--\ref{Glo3:Mikunallan}).\\
...
Accusative. In the \CH{} dialect, the accusative\index[sub]{accusative} is realized \phono{-kta} after a short vowel and \phono{-ta} after a long vowel or consonant~(\ref{Glo3:piluta}),~(\ref{Glo3:apakunki}); in all other dialects it is realized as \phono{-ta} in all environments. \phono{-ta} indicates the object or goal of a transitive verb~(\ref{Glo3:Asnuqa}),~(\ref{Glo3:maqarura}).\\
...
\glotran{Toss out \pb{the cows}, \pb{all of them}! I’m going to go uphill.}{}%eng+spa trans
{}{}%rec - time
...
\glotran{That’s how they found out he was a condor.}%eng
{‘En éso supieron que era condor’.}%spa
{}{}%rec - time

\noindent
With \phono{-na} nominalizations, \phono{-ta} may be omitted. In many instances, \phono{-ta} does not indicate accusative case. \phono{-ta} may indicate the goal of movement of a person~(\ref{Glo3:Siqashpaqa}),~(\ref{Glo3:rirqani}), \phono{-n-ta} may indicate \lsc{path}~(\ref{Glo3:shamushpa}).\footnote{Thanks to Willem Adelaar for pointing this out to me.}\\
...
\glotran{Going up, he threw the ghost inside.}%eng
...
\glotran{I went \pb{to the \textit{quingual} grove} to carry firewood.}{}%eng+spa trans
{}{}%rec - time
...
Instrumental, comitative. \phono{-wan} indicates means or company\index[sub]{comitative}. \phono{-wan} may mark an instrument\index[sub]{instrumental} or item which is essential to the event~(\ref{Glo3:qalatuykushpa}),~(\ref{Glo3:Qaliqa}).\\
...
\glotran{Why are you walking around with that zombie?}%eng
...
\glotran{Her cheese would be from her goats’ [milk] and from her cows’[milk].}%eng
...
Noun-noun relations more specific than the ‘in’ and ‘of’, for example, of \phono{-pi} and \phono{-pa} are expressed by noun phrases headed by nouns which name relative positions (see §~\ref{ssec:locnouns} on locative nouns)~(\ref{Glo3:karutam}--\ref{Glo3:pasayan}). Such nouns include, for example, \phono{qipa} ‘rear’; \phono{hawa} ‘top’; and \phono{trawpi} ‘center’. The head (relational) noun is inflected for person, agreeing with the noun to which it is related; this noun may be inflected with genitive \phono{-pa} (\phono{pantyun\pb{-pa} qipa-\pb{n}} ‘behind the cemetery’ \lit~‘of the cemetery its behind’).\\
...
\glotran{My mother would come uphill bringing my \pb{food}, carrying it with her donkey.}{}%eng+spa trans
{}{}%rec - time
...
\noindent
Followed by an possessive suffix plus the copula auxiliary inflected for third person (null just in case tense/aspect are not specified), \phono{-na} indicates necessity (\ie,~it forms a universal deontic/teleological modal) (\phono{taqsa-na-yki} ‘you have to wash’)~(\ref{Glo3:Sibadayta}),~(\ref{Glo3:Hinata}).\\
...
\noindent
In combination with the purposive case suffix \phono{-paq}, \phono{-na} forms subordinate clauses that indicate the purpose of the action expressed in the main clause (\phono{qawa-na-y-paq} ‘so I can see’)~(\ref{Glo3:Ganawkuna}--\ref{Glo3:kunihuqa}).\\
...
\glotran{You \pb{left to look} for that little \textit{vicuña} to \pb{domesticate}.}{}%eng+spa trans
{}{}%rec - time
...
\noindent
With the verb \phono{kay} ‘be’ \phono{-q} forms the habitual past (\phono{asi-ku-q} \phono{ka-nki} ‘you used to laugh’)~(\ref{Glo3:Unayqa}--\ref{Glo3:Sirdallawan}) (see~§~\ref{par:iterative}).\\
...
\glotran{Formerly, they used to make table cloths; they used to embroider table cloths, formerly.}%eng
...
\noindent
\phono{-sHa} may form nouns referring to the place where \lsc{e} (\phono{dipurti ka-sha-n} ‘where there are sports’)~(\ref{Glo3:Wambraqa}--\ref{Glo3:Riyasan}).\\
...
\noindent
\phono{-y} nominalizations may refer to the object or event in which \lsc{v} is realized (\phono{ishpa-} ‘urinate’~→~\phono{ishpa-y} ‘urine’; \phono{nana-} ‘hurt’~→~\phono{nana-y} ‘pain’; \phono{rupa-} ‘burn’~→ \phono{rupa-y} ‘sunshine’)~(\ref{Glo3:Warminpa}--\ref{Glo3:Aligrakuyan}).\\
...
Accompaniment, adjacency. \phono{-ntin} indicates that the referent of the base accompanies or is adjacent to another entity (\phono{allqu-\pb{ntin}} ‘with her dog’)~(\ref{Glo3:Vistigashpaqa}--\ref{Glo3:Trayamura}).\\
...
Possession. \phono{-yuq} derives nouns referring to the possessor of the referent of the base~(\ref{Glo3:dimandakurun}--\ref{Glo3:altupam}).\\
...
Partnership. \phono{-masi} indicates partnership. It attaches to \lsc{n}s to derive \lsc{n}s generally translated ‘\lsc{n}-mate’ ‘fellow \lsc{n}’~(\ref{Glo3:mikurunchik}),~(\ref{Glo3:Chaywan}), or ‘co-\lsc{n}’ (\phono{puñu-q}~→~\phono{puñu-q-masi} ‘bedmate’). \phono{-masi} is not very widely employed.\\
...
Diminutive, limitative. \phono{-cha} attaches to \lsc{n}s to derive \lsc{n}s with the meaning ‘little~\lsc{n}’~(\ref{Glo3:Wambra}--\ref{Glo3:trabaha}).\\
...
\noindent
Applied to other substantives \phono{-cha} may function as a limitative --~‘just~\lsc{s}’, ‘only~\lsc{s}’~(\ref{Glo3:kakullayan}).\\
...
\noindent
\phono{Mama-cha} (mother-\lsc{dim}) and \phono{tayta-cha} (father-\lsc{dim}) are lexicalized, meaning ‘grandmother’ and ‘grandfather’ respectively~(\ref{Glo3:sirvintin}).\\
