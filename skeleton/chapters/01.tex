...
\fbox{\includegraphics[width=0.8\textwidth]{figures/yauyos1borders.png}}

\begin{tikzpicture}
\node at (0,0) [inner ysep=\baselineskip, align=center, baseline, font=\footnotesize] (key) {\textsc{Key}\\\\
	\begin{tabular}{l@{\hspace{.25cm}}l@{\hspace{1cm}}l@{\hspace{.25cm}}l@{\hspace{1cm}}l@{\hspace{.25cm}}l}
	\tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yauyellow}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Aymaran & \tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yaured}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Cahuapanan & \tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yaubrown}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Harákmbut \\
	\tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yauearth}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Jivaroan & \tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yaulightgreen}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Maipurean  &\tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yaudarkgreen}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Panoan \\
	\tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yaupink}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Quechuan & \tikz[baseline] \node at (1,.1) [rectangle, draw, fill={black}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Tacanan  &\tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yaurose}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Tucanoan \\
	\tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yausavannah}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Tupian & \tikz[baseline] \node at (1,.1) [rectangle, draw, fill={black}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Witotoan  &\tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yauorange}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Yaguan \\
	\tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yaugrey}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & Zaparoan & \tikz[baseline] \node at (1,.1) [rectangle, draw, fill={yaudarkviolet}, anchor=base, minimum width=30pt, minimum height=20pt] {}; & \multicolumn{3}{l}{Language Isolate} \\
	\end{tabular}
};
\end{tikzpicture}
