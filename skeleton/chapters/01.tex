...
\begin{figure}[!ht]
\centering
\index[sub]{Proto-Quechua}\index[sub]{Huaihuash}\index[sub]{Huailay}\index[sub]{Huailas}\index[sub]{Conchucos}\index[sub]{Ap-am-ah}\index[sub]{Alto Pativilca}\index[sub]{Alto Marañón}\index[sub]{Alto Huallaga}\index[sub]{Huancay}\index[sub]{Yaru}\index[sub]{Jauja}\index[sub]{Huanca}\index[sub]{Huangáscar}\index[sub]{Topará}\index[sub]{Pacaraos}\index[sub]{Huampuy}\index[sub]{Yungay}\index[sub]{Laraos}\index[sub]{Lincha}\index[sub]{Apurí}\index[sub]{Chocos}\index[sub]{Madeán}\index[sub]{Cañaris}\index[sub]{Incahuasi}\index[sub]{Cajamarca}\index[sub]{Chinchay}\index[sub]{Amazonas}\index[sub]{San Martín}\index[sub]{Loreto}\index[sub]{Ecuador}\index[sub]{Colombia}\index[sub]{Ayacucho}\index[sub]{Cuzco}\index[sub]{Puno}\index[sub]{Bolivia}\index[sub]{Argentina}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}[%
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.889\textwidth]{figures/per_eth}
\end{center}
...
\begin{figure}[!ht]
\begin{center}
\index[sub]{Proto-Quechua}\index[sub]{Huaihuash}\index[sub]{Huailay}\index[sub]{Huailas}\index[sub]{Conchucos}\index[sub]{Ap-am-ah}\index[sub]{Alto Pativilca}\index[sub]{Alto Marañón}\index[sub]{Alto Huallaga}\index[sub]{Yaru}\index[sub]{Jauja}\index[sub]{Huanca}\index[sub]{Pacaraos}\index[sub]{Huampuy}\index[sub]{Yungay}\index[sub]{Laraos}\index[sub]{Southern Yauyos}\index[sub]{Cañaris}\index[sub]{Incahuasi}\index[sub]{Cajamarca}\index[sub]{Chinchay}\index[sub]{Amazonas}\index[sub]{San Martín}\index[sub]{Loreto}\index[sub]{Ecuador}\index[sub]{Colombia}\index[sub]{Ayacucho}\index[sub]{Cuzco}\index[sub]{Puno}\index[sub]{Bolivia}\index[sub]{Argentina}
\resizebox{\textwidth}{!}{%
\begin{tikzpicture}[%
treenode/.style = {align=center,inner sep=2ex,text centered},
level 1/.style={sibling distance=52ex,level distance=12ex,font=\Large}, 
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%
\tabnametitle{Apurí-Madeán-Viñac}
%%%%%%%%%%%%
\tabnametitles{Apurí}
\tabnames{Apurí}{AA, DO, Pedro Carrún}\\[1ex]
%%%%%%%%%%%%
\tabnametitles{Madean}
\tabnames{Madeán}{Victoria Díaz, Gabino Huari, Ernestina Huari, Efrén Yauri}
\tabnamess{Tayamarca}{Isabel Chávez}\\[1ex]
%%%%%%%%%%%%
\tabnametitles{Viñac}
\tabnames{Viñac}{Dona Alvarado, Eudosia Alvarado, Pripodina Auris, Jesus Centeno, Meli Chávez, Delfina Chullukuy, Martina Guerra, Victoria Guerra, Carmen Huari, Aleka Madueño, Acención Madueño, Melania Madueño, Hilda Quispe, Angélica Romero, Saturnina Utcañe}
\tabnamess{Casa Blanca}{Margarita Madueño}
...
\tabnamess{Ortigal}{AB}
\tabnamess{Llanka}{Octavia Arco, Bautista Cárdenas}
\tabnamess{Qanta}{Octavio Sulluchuco}
\tabnamess{Qunyari}{Cecilia Guerra, Emiliano Rojas}
\tabnamess{Shutco}{María Guerra, Teresa Guerra, Alejandra Quispe}
...
%%%%%%%%%%%%%%%%%%%%%%%%
\tabnametitle{Azángaro-Chocos-Huangáscar}
%%%%%%%%%%%%
\tabnametitles{Azángaro}
\tabnames{Azángaro}{Anselma Caja, Filipa Postillón}
\tabnamess{Colca}{Genoveva Rodríguez, Lucía Rodríguez}
\tabnamess{Marcalla}{Fortunato Gutiérrez, Isak Gutiérrez}
\tabnamess{Puka Rumi}{Alcibiada Rodríguez}
\tabnamess{Villaflor}{Victorina Aguado, Senovia Gutiérrez}\\[1ex]
%%%%%%%%%%%%
\tabnametitles{Chocos}
\tabnames{Chocos}{Honorato B., Bonifacia de la Cruz, Julia Mayta}\\[1ex]
%%%%%%%%%%%%
\tabnametitles{Huangáscar}
\tabnames{Huangáscar}{Benedicta Lázaro, CW, Luisa Gutiérez, PP, Victoria Quispe, Teódolo Rodríguez, Natividad Saldaña}\\
\tabnamess{Tapalla}{Grutilda Saldaño; Eudisia Vicente}\\[3ex]
%%%%%%%%%%%%%%%%%%%%%%%%
\tabnametitle{Cacra-Hongos}
%%%%%%%%%%%%
\tabnametitles{Cacra}
\tabnames{Cacra}{Iris Barrosa, Maximina Barrosa, Regina Huamán}\\[1ex]
%%%%%%%%%%%%
\tabnametitles{Hongos}
\tabnames{Hongos}{Archi V., Eduardo Centeno, Dina Huamán, Leona Huamán, SA, Sabina Huamán, Senaida Oré, Hipólita Santos, Maximina Tupac, Erlinda Vicente}\\[3ex]
%%%%%%%%%%%%%%%%%%%%%%%%
\tabnametitle{Lincha-Tana}
%%%%%%%%%%%%
\tabnametitles{Lincha}
\tabnames{Lincha}{Ninfa Flores, Anselma Vicente, Sofía Vicente}\\[1ex]
%%%%%%%%%%%%
\tabnametitles{Tana}
\tabnames{Tana}{Amador Flores, Gabina Flores, Lucio Flores, Dina Lázaro, Elisa Mancha, Isabel Mancha}\\[3ex]
%%%%%%%%%%%%%%%%%%%%%%%%
\tabnametitle{San Pedro de Huacarpana}
%%%%%%%%%%%%
\tabnametitles{San Pedro de Huacarpana}
\tabnames{Liscay}{Santa Ayllu, Edwin Fuentes, Neli Fuentes, Elvira Huamán, Sofía Huamán, Lucía Martinez, RF, Rosa O., Maximina Paloma, Juan Páucar}
\tabnames{San Pedro}{Bernarda S. \emph{et al.}}
...
\begin{footnotesize}
\gloexe{}{}{}%
{\pb{Ishkayninchik} ripukushun.~\textup{\AMV}\hspace{29.5ex}Southern Yauyos example}%
...
\glotranexe{‘Let’s go \pb{both of us}.’\hspace{39.9ex}{English free translation}}%
{‘Nos iremos los dos’.}%
{}{}%rec - time
\end{footnotesize}
